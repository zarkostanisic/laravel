        ...
        <div class="card card-shadowed p-50 w-400 mb-0" style="max-width: 100%">
          ...
          <form>
            <ul class="alert alert-danger" v-if="errors.length > 0">
              <p v-for="error in errors" class="text-center">
                {{ error }}
              </p>
            </ul>
            ...
            <div class="form-group">
              <button class="btn btn-bold btn-block btn-primary" type="button" @click="attemptLogin()" :disabled="!isValidLoginForm">Login</button>
            </div>
          </form>
      ...
      attemptLogin(){
        ...
        axios.post('/login', {
          ...
          if(error.response.status == 422){
            ...
            this.errors.push('Something was wrong, please refresh and try again.');
          }
        });
      }
    }
